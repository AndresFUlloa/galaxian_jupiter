...
class MenuScene(Scene):
    ...
    def do_create(self):
       ...
       create_text(self.ecs_world, "HI-SCORE",6,pygame.Color(255, 50, 50),pygame.Vector2(100,10),TextAlignment.LEFT)
       create_text(self.ecs_world, "00",6,pygame.Color(255, 255, 255),pygame.Vector2(65,20),TextAlignment.LEFT)
       create_text(self.ecs_world, "JUPITER GALAXIAN",6,pygame.Color(255, 255, 255),pygame.Vector2(120,80),TextAlignment.CENTER)
       create_text(self.ecs_world, "1 PLAYER",6,pygame.Color(180, 119, 252),pygame.Vector2(120,108),TextAlignment.CENTER)
       create_text(self.ecs_world, "►",5,pygame.Color(255, 255, 255),pygame.Vector2(80,108),TextAlignment.LEFT)
       create_text(self.ecs_world, "NAMCOT",6,pygame.Color(255, 50, 50),pygame.Vector2(120,178),TextAlignment.CENTER)
       create_text(self.ecs_world, "©1979  1984 NAMCO LTD.",6,pygame.Color(255, 255, 255),pygame.Vector2(120,198),TextAlignment.CENTER)
       create_text(self.ecs_world, "ALL RIGHTS RESERVED",6,pygame.Color(255, 255, 255),pygame.Vector2(120,208),TextAlignment.CENTER)
